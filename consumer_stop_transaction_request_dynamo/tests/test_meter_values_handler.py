...
class TestMeterValuesHandler:
    ...
    def test_meter_values(self):
        charge = ChargeKeeper()
        meter_values = []
        meter_values = meter_values + self.generate_session(start_time="2023-01-01T09:00:00Z",
                                             charge_point_id="ee361d57-74cb-4f66-bda0-f5ff6eab50bf",
                                             charge_keeper=charge)
        meter_values = meter_values + self.generate_session(start_time="2023-01-01T11:00:00Z",
                                             charge_point_id="8916d07e-e8e6-489c-b0c3-fb1ce057adc4",
                                             charge_keeper=charge)
        meter_values = meter_values + self.generate_session(start_time="2023-01-01T10:00:00Z",
